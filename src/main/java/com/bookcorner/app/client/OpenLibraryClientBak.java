...
public class OpenLibraryClientBak {
    ...
    // <editor-fold desc="Search API" default-state="collapsed">

    // *********************************************************
    // Search Books and Authors using Open Library API
    // *********************************************************
     ...
     */
    public List<String> searchBooks(String query, int offset, int limit) throws IOException {
    ...
    // </editor-fold>
    // <editor-fold desc="Details API" default-state="collapsed">

    public Optional<String> fetchBookDetailsByOlid(String olid) throws IOException {
    ...
    // </editor-fold>
    // <editor-fold desc="Private Methods" default-state="collapsed">
