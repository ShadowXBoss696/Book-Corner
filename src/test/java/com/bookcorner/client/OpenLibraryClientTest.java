...
class OpenLibraryClientTest {
    ...
    @Test
    void searchBooks_shouldReturnEditionIds_whenSuccessful() throws Exception {
        List<String> results = client.searchBooks("Diary of a Wimpy Kid", 10);
    ...
    @Test
    void searchBooks_shouldReturnEmptyList_whenNoResultsFound() throws Exception {
        List<String> results = client.searchBooks("asdlkfjasldkfjalksdjflkasjdf", 10);
        assertNotNull(results, "The result should not be null");
        assertTrue(results.isEmpty(), "The result should be empty for a gibberish query");
    }

    @Test
    void fetchBookByOLID_shouldReturnBookResponse_whenSuccessful() throws Exception {
    ...
    @Test
    void fetchBookByOLID_shouldReturnEmptyOptional_whenNoResultsFound() throws Exception {
        Optional<BookResponse> bookResponse = client.fetchBookByOLID("OL00000000M");
